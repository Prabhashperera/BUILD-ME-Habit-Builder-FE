        ...
        <div className="hidden lg:flex lg:col-span-2 flex-col justify-center items-center p-12 bg-linear-to-br from-emerald-900/40 via-slate-900/80 to-teal-900/40 relative overflow-hidden">
          ...
          <div className="relative z-10 text-center space-y-6">
            ...
            <h2 className="text-3xl font-extrabold text-white tracking-tight">
              Keep The <br />{" "}
              <span className="text-emerald-400">Streak Alive</span>
            </h2>
            <p className="text-emerald-100/60 text-sm max-w-xs mx-auto leading-relaxed">
              Consistency is the key. Log in to track your daily wins and evolve
              your avatar.
            </p>
        ...
        <div className="p-8 md:p-12 lg:col-span-3 flex flex-col justify-center relative">
          <div className="mb-8">
            ...
            <p className="text-slate-400 text-sm">
              Focus on the process. Trust the result.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <button
              type="button"
              className="flex items-center justify-center gap-2 p-3 bg-slate-800/50 hover:bg-slate-800 border border-slate-700 hover:border-slate-600 rounded-lg text-slate-300 transition-all group cursor-pointer"
            >
          ...
          <Link to={"/signup"}>
            <p className="mt-8 text-center text-slate-500 text-sm">
              ...
              <span className="text-emerald-400 hover:text-emerald-300 font-bold hover:underline transition-colors">
                Start your journey
              </span>
            </p>
          </Link>
