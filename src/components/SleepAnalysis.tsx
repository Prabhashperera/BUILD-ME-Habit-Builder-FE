...
function SleepAnalysis(props: any) {
    ...
    return (
        <div className="relative w-full max-w-7xl mx-auto overflow-hidden bg-black font-sans text-white selection:bg-indigo-500/30 rounded-[2.5rem] border border-white/5 shadow-2xl">
